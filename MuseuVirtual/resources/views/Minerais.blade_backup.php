...
<body class="bg-gradient-to-b from-[#ACB18E] from-0.5% via-[#73785C] via-5% to-[#363C27] to-20% ">
    ...
    <h1 class="font-[Arial] text-[50px] ms-80 text-[#F1EEDD] pb-6 pt-16"><strong>Minerais</strong></h1>
    <div class="px-80">
        <img class= "pb-40 w-full object-cover" src="/assets/img/image 2.png" alt="Foto do mineral tal">
    </div>
    ...
    <div class="grid grid-cols-2 gap-8 ">
        @foreach ($minerais as $item)
            <figure class="pl-80 w-full">
                ...
                <img class="object-cover w-[500px] h-[500px] rounded-xl" src="{{ asset('storage/' . $fotoExibir->caminho) }}" alt="Imagem do mineral tal">
                <figcaption>
                    <h3 class="font-[Arial] text-[30px] text-[#F1EEDD] pt-4"><strong>{{$item->nome}}</strong></h3>
                </figcaption>
            </figure>
        @endforeach
    </div>
